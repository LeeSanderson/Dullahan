/*
  PhantomJS.NET project - a managed code assembly wrapper around PhantomJS
  ...
  Changes: 
    ...
    Removed static instance and made constructor public
	Removed refernces to phantom.h and config.h
*/
