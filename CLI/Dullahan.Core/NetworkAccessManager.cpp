/*
  ...
  Changes: 
	...
	Removed referneces to phantom.h
...
// public:
NetworkAccessManager::NetworkAccessManager(QObject *parent, const Config *config, CookieJar *cookieJar)
...
#include "gen\moc_NetworkAccessManager.cpp"